...
public class RetrievalService {
    ...
    public List<Document> retrieveDocuments(Query query, String sessionId, int topK) {
        Query finalQuery = queryTransformerModule.transformQuery(query.text(), sessionId);
