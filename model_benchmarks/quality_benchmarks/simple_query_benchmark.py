...
RESULTS_CSV= resolve_path_parent(os.environ.get("SIMPLE_RESULTS_CSV", "simple_results_temperature_0.csv"))
...
def compute_composite(
    ...
    parts  += w_embed * embed_sim   # always present
    total_w += w_embed
...
def main(limit=None):
    ...
    req_headers = {"Accept": "text/event-stream" if STREAM_RESPONSES else "application/json, text/plain"}
    if TOKEN:
        ...
        for index, rec in enumerate(records, start=1):
            ...
            try:
                ...
                writer.writerow({
                    ...
                    "score_embed": "", "score_bert": "",
                    "score_nli": "", "score_composite": "",
                    "model": MODEL_NAME,
                })
                continue
